...
parser.add_argument('--augm', default="none", type=int)
...
CHOSEN_ENV = '11_vs_11_easy_stochastic'
CHOSEN_ALGO = 'PPO'

AUGMS = ["none","no_clip","no_reward_norm","orth_init","adam_al"]
...
class PPO:
    ...
    def learn(self):
        ...
        if CHOSEN_AUGM == 'no_clip':
            ...
            val_epsilon = self.epsilon

       # print(val_epsilon)
        value_pred_clipped = values + (values_new - values).clamp(-val_epsilon, val_epsilon)
